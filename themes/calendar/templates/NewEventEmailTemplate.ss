        ...
        <td class="container">
            <div class="content">
                ...
                <span class="preheader">
                    <% if $EnquiryType %>$EnquiryType from <% end_if %>
                    <% if $Title %>$Title, <% end_if %>
                    <% if $FirstName %>$FirstName <% end_if %>
                    <% if $LastName %>$LastName at<% end_if %>
                    <% if $Organisation%>$Organisation <% end_if %>
                </span>
                <table class="main">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td class="content-block">
                                ...
                                <br>&#169;$Now.Year  <a href="$AbsoulteBaseURL">Social Investment Agency</a>. All Rights
                                Reserved.
                            </td>
                        </tr>
                    </table>
